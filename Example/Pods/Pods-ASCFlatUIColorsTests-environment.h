...
// ASCFlatUIColors
#define COCOAPODS_POD_AVAILABLE_ASCFlatUIColors
#define COCOAPODS_VERSION_MAJOR_ASCFlatUIColors 0
#define COCOAPODS_VERSION_MINOR_ASCFlatUIColors 1
#define COCOAPODS_VERSION_PATCH_ASCFlatUIColors 0
